...
* [📝 빌링키 관리 API](api/api-4/README.md)
  ...
  * [⌨ 빌링키 정보 복수조회 API](api/api-4/api.md)
  * [⌨ 빌링키 결제예약 조회 API](api/api-1/api-4.md)
* [🧭 정기결제 관련 API](api/api/README.md)
  * [⌨ 결제 예약 API](api/api/schedule-api.md)
  * [⌨ 결제 예약취소 API](<api/api/api-1 (1).md>)
  * [⌨ 결제예약 복수조회 API](api/api/api-2.md)
  * [⌨ 결제예약 단건조회 API](<api/api/api-3 (1).md>)
  * [⌨ 결제예약 복수조회(빌키) API](<api/api/api-4 (1).md>)
* [🪂 비 인증 결제관련 API](api/api-1/README.md)
  * [⌨ 비 인증 결제(빌링키) API](<api/api-1/api (1).md>)
...
* [👮♂ 본인인증 관련 API](api/api-3/README.md)
  ...
  * [⌨ 본인인증 완료 API](api/api-4/api-2.md)
  * [⌨ 본인인증 요청 API](api/api-4/api-3.md)
