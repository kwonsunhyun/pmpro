...
* [💳 결제관련 API](api/api/README.md)
  * [❌ 결제취소 API](api/api/api.md)
  * [⌨ 결제내역 단건조회 API](api/api/api-1.md)
  * [⌨ 결제내역 복수조회 API](api/api/api-2.md)
  * [⌨ 결제상태기준 복수조회 API](api/api/api-3.md)
  * [⌨ 결제 복수조회(주문All) API](api/api/all-api.md)
  * [⌨ 결제 복수조회(주문UQ) API](api/api/uq-api.md)
  * [⌨ 결제 상세내역 조회 API](api/api/api-4.md)
  * [⌨ 빌링키 결제 복수조회 API](api/api/api-5.md)
* [📝 빌링키 관리 API](api/api-1/README.md)
  * [⌨ 빌링키 발급 API](api/api-1/api-1.md)
  * [⌨ 빌링키 삭제 API](api/api-1/api.md)
  * [⌨ 빌링키 정보 단건조회 API](api/api-1/api-2.md)
  * [⌨ 빌링키 정보 복수조회 API](api/api-1/api-3.md)
  * [⌨ 빌링키 결제예약 조회 API](api/api-1/api-4.md)
* [🧭 정기결제 관련 API](api/api-2/README.md)
  * [⌨ 결제 예약 API](api/api-2/api.md)
  * [⌨ 결제 예약취소 API](api/api-2/api-1.md)
  * [⌨ 결제예약 복수조회 API](api/api-2/api-2.md)
  * [⌨ 결제예약 단건조회 API](api/api-2/api-3.md)
  * [⌨ 결제예약 복수조회(빌키) API](api/api-2/api-4.md)
* [🪂 비 인증 결제관련 API](api/api-3/README.md)
  * [⌨ 비 인증 결제(빌링키) API](api/api-3/api.md)
  * [⌨ 비 인증 결제(일회성) API](api/api-3/api-1.md)
* [👮♂ 본인인증 관련 API](api/api-4/README.md)
  * [⌨ 본인인증 결과조회 API](api/api-4/api.md)
  * [⌨ 본인인증 정보삭제 API](api/api-4/api-1.md)
* [🎫 간편결제 서비스 API](api/api-5.md)
* [💵 현금영수증 API](api/api-6.md)
* [🍶 부가서비스 API](api/api-7.md)
