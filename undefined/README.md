...
![아임포트 관리자페이지 로그인 화면](<../.gitbook/assets/image (4).png>) ![회원가입 화면](<../.gitbook/assets/image (15).png>)
...
{% hint style="info" %}
각 PG사별 **테스트 설정 및 실 계정 설정**이 **상이**합니다. 자세한 PG사별 설정 방법은 [**링크**](2.-pg/pg.md)를 통해 확인하세요
{% endhint %}
