...
당사가 제공하는 [**빌링키 발급 REST API** ](../../../api/api-1/)를 통해 빌링키 발급을 요청하고 결과값에 따라 응답을 반환하는 예제입니다.
...
키인결제 REST API [**`/subscribe/payments/onetime`**](../../../api/api-1/)를 사용하면 빌링키 발급과 최초 결제를 같이 요청할 수 있습니다.
{% endhint %}
